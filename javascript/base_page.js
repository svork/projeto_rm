// Este arquivo é apenas uma função teste em JavaScript
function estamos_desenvolvendo(){
  document.getElementById("teste01").innerHTML = "Esta página está sendo desenvolvida, volte mais tarde";
